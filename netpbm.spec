...
Patch19: netpbm-docfix.patch
Patch20: netpbm-ppmfadeusage.patch
Patch21: netpbm-fiasco-overflow.patch
Patch22: netpbm-CVE-2009-4274.patch
Patch23: netpbm-lz.patch
Patch24: netpbm-pnmmontagefix.patch
Patch25: netpbm-cmuwtopbm.patch
Patch26: netpbm-pamtojpeg2k.patch
...
%patch19 -p1
%patch20 -p1 -b .ppmfadeusage
%patch21 -p1 -b .fiasco-overflow
%patch22 -p1 -b .CVE-2009-4274
%patch23 -p1 -b .lz
%patch24 -p1 -b .pnmmontagefix
%patch25 -p1 -b .cmuwtopbmfix
%patch26 -p1 -b .pamtojpeg2k
...
%changelog
* Tue Jun  1 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-11
- add -fno-strict-aliasing to CFLAGS (#596191)

* Wed May 12 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-10
- add fix for pamtosvg (#565445)

* Mon May  3 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-9
- fix cmuwtopbm so that magic bytes test actually works
- fix pamtojpeg2k (don't close stdout twice)

* Fri Apr 23 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-8
- fix CVE-2007-2721 (#530120)

* Thu Mar 18 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-7
- do not package patch backups in documentation

* Tue Mar 16 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-6
- pgmtopbm should generate PBM, not PAM file
- forwardport pnmmontage from 10.35 to make it work
- fix pamstretch-gen

* Thu Feb 25 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-5
- remove obsolete pgmtopbm and pnmcomp, symlink them to the new
  compatible variants
- fix ppmfade -h, --help options
- add missing man pages
- pnmmargin won't create leftovers in /tmp
- add Requires: ghostscript
- link against -lz

* Wed Feb 10 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-4
- fix CVE-2009-4274 (#563288)

* Wed Jan 27 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-3
- fix buffer overflow in pnmtofiasco

* Wed Jan 20 2010 Jindrich Novy <jnovy@redhat.com> 10.47.05-2
- fix documentation
